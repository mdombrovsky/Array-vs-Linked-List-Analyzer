...
int main (int argc, char**argv){
    ...
    switch(option){
        case 1:
            strcpy(fileName,"../graphs/replace_list.csv");
            break;
        case 2:
            strcpy(fileName,"../graphs/insert_list.csv");
            break;
        case 3:
            strcpy(fileName,"../graphs/delete_list.csv");
            break;
        case 4:
            strcpy(fileName,"../graphs/swap_list.csv");
            break;
        default:
